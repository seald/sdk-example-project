const { socketRemoveRoomValidator } = require('../validators/rooms')
const { socketPostMessageValidator } = require('../validators/rooms')
const { socketRoomEditValidator } = require('../validators/rooms')
const { socketCreateOne2OneRoomValidator } = require('../validators/rooms')
const { socketCreateMultiUsersRoomValidator } = require('../validators/rooms')
