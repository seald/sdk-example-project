...
| [Server-side generation of the signup JWT](https://docs.seald.io/en/sdk/example/signup-jwt.html) |Generates the user signup JWT on the server side instead of the client side| [`4-signup-jwt`](https://github.com/seald/sdk-example-project/tree/4-signup-jwt)         | [`3-localstorage`](https://github.com/seald/sdk-example-project/tree/3-localstorage)     |
| [Protection with 2-man-rule](https://docs.seald.io/en/sdk/example/2-man-rule.html)               |Replacement of password protection with a protection with 2-man-rule | [`5-two-man-rule`](https://github.com/seald/sdk-example-project/tree/5-two-man-rule)     | [`4-signup-jwt`](https://github.com/seald/sdk-example-project/tree/4-signup-jwt)         |
...
|------------------------------|---------------------------------------|---
| `APPLICATION_SALT`           | Salt used for pre-derivation          | `2-pre-derivation`, `3-localstorage`, `4-signup-jwt`
| `JWT_SHARED_SECRET_ID`       | JWT shared secret ID (for signup JWT) | `1-quick-start`, `2-pre-derivation`, `3-localstorage`
| `JWT_SHARED_SECRET`          | JWT shared secret (for signup JWT)    | `1-quick-start`, `2-pre-derivation`, `3-localstorage`
| `APP_ID`                     | App ID                                | `1-quick-start`, `2-pre-derivation`, `3-localstorage`, `4-signup-jwt`, `5-two-man-rule`
| `API_URL`                    | Seald API URL                         | `1-quick-start`, `2-pre-derivation`, `3-localstorage`, `4-signup-jwt`, `5-two-man-rule`
| `KEY_STORAGE_URL`            | SSKS API URL                          | `1-quick-start`, `2-pre-derivation`, `3-localstorage`, `4-signup-jwt`, `5-two-man-rule`
...
| `JWT_SHARED_SECRET_ID`    | JWT shared secret ID (for signup JWT)                                                                                                                                                  | `4-signup-jwt`, `5-two-man-rule`
| `JWT_SHARED_SECRET`       | JWT shared secret (for signup JWT)                                                                                                                                                     | `4-signup-jwt`, `5-two-man-rule`
| `APP_ID`              | App ID (for user licence & SSKS)                                                                                                                                                       | `4-signup-jwt`, `5-two-man-rule`
| `KEY_STORAGE_URL`     | API URL (for SSKS)                                                                                                                                                                     | `5-two-man-rule`
| `KEY_STORAGE_APP_KEY` | App Key (for SSKS)                                                                                                                                                                     | `5-two-man-rule`
